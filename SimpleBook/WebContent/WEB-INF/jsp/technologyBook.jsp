			...
			<c:forEach var="book" items="${bookList}">
				<tr class="success">
					<c:if test="${book.type.id==2}">
						...
						<td><textarea rows="1" cols="40" disabled="" class="form-control">${book.book_detail}</textarea></td>
						<td>${book.book_year}</td>
						<td>${book.type.name}</td>

						<td>
							<button class="btn btn-success ok" data-toggle="modal" data-target="#show-${book.id }">show</button>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="form-group">
												<label>Book Detial : </label> ${book.book_detail}
											</div>
											<div class="form-group">
...
var showbooks = $('#example').DataTable( {
	ajax: contextPath + '/showInspi.html',
