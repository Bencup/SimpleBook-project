...
<!-- content -->
<div class="container">
	  <%-- <table class="table table-tapdown display " id="myTable">
		<thead>
			<tr bgcolor="skyblue">
				<th scope="col"></th>
				<th scope="col" class="u-center">Book name</th>
				<th scope="col" class="u-center">Book detail</th>
				<th scope="col" class="u-center">Book Year</th>
				<th scope="col" class="u-center">Book Type</th>
				<th scope="col"></th>
			</tr>
		</thead>
		<tbody>
			<c:forEach var="book" items="${bookList}">
				<tr class="success">
					...
					<td class="u-center"><textarea rows="1" cols="40" disabled="" class="form-control">${book.book_detail}</textarea> </td>
					<td class="u-center">${book.book_year}</td>
					<td class="u-center">${book.type.name}</td>
